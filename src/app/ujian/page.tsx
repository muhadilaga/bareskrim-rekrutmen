  ...
  try {
    ...
    return (
      <div className="flex min-h-[70vh] items-center justify-center px-4">
        <Card strong className="w-full max-w-md p-8 text-center animate-scale-in">
          <div className="text-4xl">⚠️</div>
          <h1 className="mt-4 font-display text-xl font-bold text-red-300">Terjadi Kesalahan</h1>
          <p className="mt-3 text-sm text-zinc-400">
            Gagal memuat halaman ujian. Coba muat ulang atau kembali ke beranda.
          </p>
          <p className="mt-2 text-xs text-zinc-500">{msg}</p>
          <div className="mt-6 flex flex-col gap-3">
            <Link href="/ujian" className="inline-block">
              <Button variant="gold" className="w-full">Muat Ulang</Button>
            </Link>
            <Link href="/" className="inline-block">
